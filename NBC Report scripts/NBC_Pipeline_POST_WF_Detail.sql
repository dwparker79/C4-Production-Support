...
SELECT 'U:\Data\C4_PIPELINE_POST_WF_DETAIL_'||TO_CHAR(SYSDATE,'MMDDYYYY')||'.TXT' filename FROM DUAL;
SPOOL &&filename
...
AND proc.end_dtime is null
AND not exists (SELECT 1 from ibs_wf_act_inst wflow
